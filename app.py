...
try:
    ...
    # Búsqueda flexible de nombres de pestañas (ignora tildes, mayúsculas y espacios extra)
    ...
    if not sheet_plan or not sheet_prod:
        st.error(f"No se encontraron las pestañas requeridas. Pestañas disponibles en tu Excel: {xl_prod.sheet_names}")
        st.stop()
